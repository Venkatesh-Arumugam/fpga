/******************************************************************************
 * CONFIGURATION 5: MEMORY OPTIMIZED
 * File: dct_config5_memopt.cpp
 * Description: Optimized memory bursting with wider interfaces
 * Expected: Better memory bandwidth utilization
 ******************************************************************************/
...
#pragma HLS INTERFACE m_axi port=inR offset=slave bundle=gmem0 depth=2073600 max_read_burst_length=256 latency=64
#pragma HLS INTERFACE m_axi port=inG offset=slave bundle=gmem1 depth=2073600 max_read_burst_length=256 latency=64
#pragma HLS INTERFACE m_axi port=inB offset=slave bundle=gmem2 depth=2073600 max_read_burst_length=256 latency=64
#pragma HLS INTERFACE m_axi port=outR offset=slave bundle=gmem3 depth=2073600 max_write_burst_length=256 latency=64
#pragma HLS INTERFACE m_axi port=outG offset=slave bundle=gmem4 depth=2073600 max_write_burst_length=256 latency=64
#pragma HLS INTERFACE m_axi port=outB offset=slave bundle=gmem5 depth=2073600 max_write_burst_length=256 latency=64
...
#pragma HLS STREAM variable=block_stream depth=16
    
    hls::stream<coeff_data> coeff_stream("coeff_stream");
#pragma HLS STREAM variable=coeff_stream depth=16
